...
<body>
    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <a style="background: white; border-radius: 10px; padding: 10px; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);"
                href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                <img width=60 src="{{ asset('images/logo-stmik.png') }}" alt="logo">
                <div class="d-flex flex-column ms-3">
                    <span class="fw-bold" style="font-size: 1.2rem; color: var(--primary-color);">SIPO-SWU</span>
                    <span class="text-muted" style="font-size: 0.8rem;">STMIK Widya Utama Purwokerto</span>
                </div>
            </a>
