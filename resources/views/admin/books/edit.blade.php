                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea required style="height: 200px" type="text" name="description" class="form-control"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select required class="form-select" name="category" id="category">
                            ...
                            <option value="pelajaran" {{ $book->category == "pelajaran" ? "selected" : "" }}>Buku Pelajaran
                            </option>
                            <option value="fiksi" {{ $book->category == "fiksi" ? "selected" : "" }}>Buku Fiksi</option>
                            <option value="nonfiksi" {{ $book->category == "nonfiksi" ? "selected" : "" }}>Buku Non Fiksi
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="file_path" class="form-label">File E-Book (PDF)</label>
                        <input type="file" name="file_path" class="form-control" id="file_path" accept=".pdf">
                        @if($book->file_path)
                            <a href="{{ $book->file_path }}" target="_blank" class="d-block mt-2">Lihat File Saat Ini</a>
                        @endif
                    </div>
                </div>
            </div>
